...
export class InscriptionsUploadFilesPageComponent implements OnInit {
  ...
  constructor(
    ...
    this.getIdStudent();
    this.getFonts();
    this.title = this.step === 2 ? 'II. Recibo de pago' : 'III. Solicitud de Documentos';
  }
  ngOnInit() {
  ...
  getIdStudent() {
    ...
    this.doctorate = (this.data.career === 'DOCTORADO EN CIENCIAS EN ALIMENTOS') ? true : false;
    this.mastersDegree = (this.data.career === 'MAESTRÍA EN CIENCIAS EN ALIMENTOS' || this.data.career === 'MAESTRÍA EN TECNOLOGÍAS DE LA INFORMACIÓN') ? true : false;
