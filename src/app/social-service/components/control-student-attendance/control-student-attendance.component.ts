...
@Component({
  selector: 'app-control-student-attendance',
  templateUrl: './control-student-attendance.component.html',
  styleUrls: ['./control-student-attendance.component.scss']
})
export class ControlStudentAttendanceComponent implements OnInit {
